...
Window::Window(GLint windowWidth, GLint windowHeight)
{
	...
	// PARA COMPROBAR QUE LA JERARQUIA CON LA LUZ SE HIZO DE MANERA CORRECTA (SOLO COMO EJEMPLO)
	///////////////////
	rotaeny = 0.0f;
	rotaenz = 0.0f;
	///////////////////
...
int Window::Initialise()
{
	...
	//CREAR VENTANA
	mainWindow = glfwCreateWindow(width, height, "Practica 9-2: Animacion Avanzada", NULL, NULL);
